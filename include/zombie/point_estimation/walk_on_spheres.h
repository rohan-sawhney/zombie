...
template <typename T, size_t DIM>
WalkOnSpheres<T, DIM>::WalkOnSpheres(const GeometricQueries<DIM>& queries_):
...
template <typename T, size_t DIM>
void WalkOnSpheres<T, DIM>::solve(const PDE<T, DIM>& pde,
                                  const WalkSettings& walkSettings,
                                  int nWalks, SamplePoint<T, DIM>& samplePt,
                                  SampleStatistics<T, DIM>& statistics) const
{
...
template <typename T, size_t DIM>
void WalkOnSpheres<T, DIM>::computeSourceContribution(const PDE<T, DIM>& pde,
                                                      const WalkSettings& walkSettings,
                                                      const std::unique_ptr<GreensFnBall<DIM>>& greensFn,
                                                      pcg32& rng, WalkState<T, DIM>& state) const
{
...
template <typename T, size_t DIM>
bool WalkOnSpheres<T, DIM>::applyWeightWindow(const WalkSettings& walkSettings,
                                              pcg32& rng, WalkState<T, DIM>& state,
                                              std::queue<WalkState<T, DIM>>& stateQueue) const
{
...
template <typename T, size_t DIM>
WalkCompletionCode WalkOnSpheres<T, DIM>::walk(const PDE<T, DIM>& pde,
                                               const WalkSettings& walkSettings,
                                               float distToAbsorbingBoundary,
                                               std::unique_ptr<GreensFnBall<DIM>>& greensFn,
                                               pcg32& rng, WalkState<T, DIM>& state,
...
template <typename T, size_t DIM>
T WalkOnSpheres<T, DIM>::getTerminalContribution(WalkCompletionCode code,
                                                 const PDE<T, DIM>& pde,
                                                 const WalkSettings& walkSettings,
                                                 WalkState<T, DIM>& state) const
{
...
template <typename T, size_t DIM>
void WalkOnSpheres<T, DIM>::estimateSolution(const PDE<T, DIM>& pde,
                                             const WalkSettings& walkSettings,
                                             int nWalks, SamplePoint<T, DIM>& samplePt,
                                             SampleStatistics<T, DIM>& statistics) const
{
...
template <typename T, size_t DIM>
void WalkOnSpheres<T, DIM>::estimateSolutionAndGradient(const PDE<T, DIM>& pde,
                                                        const WalkSettings& walkSettings,
                                                        int nWalks, SamplePoint<T, DIM>& samplePt,
                                                        SampleStatistics<T, DIM>& statistics) const
{
